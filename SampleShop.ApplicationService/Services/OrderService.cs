...
namespace SampleShop.ApplicationService.Services
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(IBaseRepository<long, Order> repository, IProductRepository productRepository, IBaseRepository<Guid, User> userRepository, IMapper mapper, IBaseRepository<long, OrderProduct> orderProductRepository)
        {
